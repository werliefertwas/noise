...
(function() {
  ...
  require.register('Flot', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'Flot/')); }), {});
...
;require.register("web/static/js/flot", function(exports, require, module) {
"use strict";
